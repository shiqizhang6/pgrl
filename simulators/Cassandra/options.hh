// Overall
#define MODE "BELIEF"  // default=Owens table, MEM=finite memory, PSR=psr, HMM, CHEAT, BELIEF, EXACT_PSR
...
// OLPomdp stuff
#define STEP_SIZE 0.0001 // 0.00001 // Gradient step size, a.k.a., alpha
#define STEPS_PER_EPOCH 50 // 10000 // Steps per epoch. Has implications for baseline estimation
...
#define TD_DISCOUNT 0.75 // 0.25 // Value estimate discount, a.k.a., gamma
